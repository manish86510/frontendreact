...
class FeedCard extends React.Component {
    ...
    render() {
        ...
        const { isFormVisible, open_post_details } = this.state;  //form visible
        ...
        return (
            <Card className={classes.card}>
                ...
                <CardAction post={post} toggleFormVisibility={this.toggleFormVisibility} />  {/*pasing form visiblity function */}
                <Collapse in={isFormVisible}>
                    <SlidingForm isVisible={isFormVisible} />  {/* Render form within Collapse component */}
                </Collapse>
            </Card>
        );
    }
